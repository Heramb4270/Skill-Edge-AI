...
export default function QuizAnalysis({analysis,setAnalysis}) {
  ...
  const accuracyData = {
    ...
    datasets: [
      {
        label: 'Accuracy',
        data: Object.values(Primaryanalysis["Accuracy by Difficulty"]),
  ...
  const overallData = {
    ...
    datasets: [
      {
        label: "Answers",
        data: [Primaryanalysis["Total Correct Answers"], Primaryanalysis["Total Incorrect Answers"]],
  ...
  return (
    <div className="container mx-auto p-4 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Total Questions: {Primaryanalysis["Total Correct Answers"] + Primaryanalysis["Total Incorrect Answers"]}</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-[300px]">
      ...
      <Card>
        ...
        <CardContent>
          <p>{Primaryanalysis.Suggestion_For_Improvement}</p>
        </CardContent>
      </Card>
